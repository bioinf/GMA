...
static int parse_args_tech( int argc, char *argv[], 
    ...
    while( ( c = getopt_long( argc, argv, "istrocb:x:m:p:", long_options, &option_index )) >= 0 ) 
    {
       // fprintf( stderr, "optind : %d, %c, %s\n", optind, c, optarg );
        ...
        case 'i': 
                  ...
                  strcpy( tech, "illumina" ); my_argv[TECH] = tech;
                  break;
        case 's': 
                  ...
                  strcpy( ins, "0" ); my_argv[INS] = ins;
                  strcpy( del, "0" ); my_argv[DEL] = del;
                  strcpy( tech, "solid" ); my_argv[TECH] = tech;
                  break;
        case 't': 
                  ...
                  strcpy( tech, "iontorrent" ); my_argv[TECH] = tech;
                  break;
        case 'r': 
                  ...
                  strcpy( tech, "roche" ); my_argv[TECH] = tech;
                  break;
        case 'o':
                  ...
                  strcpy( tech, "pacbio" ); my_argv[TECH] = tech;
        ...
        case 'c': 
                  ...
                  strcpy( tech, "pacbio_ec" ); my_argv[TECH] = tech;
                  break;
        case 'b': break; 
        case 'x': break; 
        case 'm': break; 
...
void call_analyzer()
{
    ...
    if( ( strcmp( tech, "pacbio"    ) == 0 ) || 
        ( strcmp( tech, "pacbio_ec" ) == 0 ) )
    {
        analyzer_long(my_argc, my_argv);
    } 
    else 
    {
        analyzer_short( my_argc, my_argv );
    }
